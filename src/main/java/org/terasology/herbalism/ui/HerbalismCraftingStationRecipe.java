...
public class HerbalismCraftingStationRecipe extends AbstractWorkstationRecipe {
    ...
    public HerbalismCraftingStationRecipe(CraftingStationRecipeComponent recipe) {
        ...
        // Search through the recipe components to find the first empty potion bottle. If it's found, break out of 
        // the loop.
        ...
        addFluidBehaviour(new ConsumeFluidBehaviour("CoreAssets:Water", 0.2f, new InventorySlotTypeResolver(
                "FLUID_INPUT")));
        ...
        PotionRecipeResultFactory potionRecipeResultFactory =
                new PotionRecipeResultFactory(Assets.getPrefab(recipe.recipeId).get(),
        ...
        for (String component : recipe.recipeComponents) {
            ...
            // If the first item in this recipe is an empty potion container, add it as a 
            // ConsumePotionContainerBehaviour.
        ...
        public EntityRef createResult(List<String> parameters, int multiplier) {
            ...
            if (potionComponent != null) {
                if (!oldPotionContainerName.equals("")) {
                    ...
                    // If the current potion bottle ref exists, then copy the durability and name over to the 
                    ...
                    // Otherwise, use the last durability value as the potionBottleDurabilityComponent - i.e., the 
                    // one to be
                    ...
                    // Create a new Durability component, and copy over the values from the old bottle's Durability 
                    // component,
    ...
    private final class ConsumePotionContainerBehaviour extends ConsumeItemCraftBehaviour {
         ...
         */
        private final PotionRecipeResultFactory potionRecipeResultFactory;
         ...
         */
        private ConsumePotionContainerBehaviour(Predicate<EntityRef> matcher, int count,
         ...
         * String. If the current item being checked is an empty potion bottle, give the result factory class that
         * information.
         *
